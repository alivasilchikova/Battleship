...
{
    class NavyFormedScreen:IScreens
    {
        ...
        public NavyFormedScreen(GameController window)
        {
            _window = window;
            ...
            _yesButton = new MenuItem(135, 40, new Font(FontFamily.GenericSerif, 24), new Font(FontFamily.GenericSerif, 25, FontStyle.Bold),
                Brushes.Black, Brushes.Black, _window);
            Off();
        }

        public NavyFormedScreen()
        {
        ...
        public void OnLoad()
        {
            _textureWin = TextureLoader.Load("textures/navy.jpg");
        ...
        public void OnRenderFrame()
        {
            if (_isActive)
            {
                ...
                _yesButton.Draw("Играем!", _window.Width, _window.Height, new PointF(375, 420));
                GL.PopMatrix();
